...
# Load an image to be used as a background for the characters
    self.image = self.get_image('diablo.png')

# Define methods to get the image  prerendered characters for each character and color
